...
class DetailCustomerExport implements FromCollection, WithEvents, WithMapping, WithHeadings
{
    /**
    ...
    {
        $details = DetailCustomer::with('company', 'gsm', 'gps', 'sensor', 'po', 'poNumber', 'vehicle', 'status')->get();
