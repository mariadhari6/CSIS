...
<td>
    <select class="select company_id-{{$maintenanceGps->id}}"  id="{{$maintenanceGps->id}}" name="company_id">
        ...
        <option value="{{ $item->company_id }}" {{ $maintenanceGps->company_id == $item->company_id ? 'selected':'' }}>{{ $item->company->company_name }}</option>
        @endforeach
    </select>
</td>
<td>
    <select class="select task-{{$maintenanceGps->id}}" id="task" name="task-{{$maintenanceGps->id}}">
        ...
        <option value="{{ $item->id }}" {{ $maintenanceGps->task == $item->id ? 'selected':'' }}>{{ $item->task }}</option>
        @endforeach
    </select>
</td>
<td>
...
<td>
    <select class="select type_gps_id-{{$maintenanceGps->id}}" id="type_gps_id" name="type_gps_id" required>
        <option value="{{$maintenanceGps->type_gps_id}}">
...
<td>
    <div class="input-div"><input type="text" class="input equipment_gps_id-{{$maintenanceGps->id}}" id="equipment_gps_id" value="{{$maintenanceGps->equipment_gps_id}}"></div>
</td>
<td>
    <div class="input-div"><input type="text" class="input equipment_sensor_id-{{$maintenanceGps->id}}" id="equipment_sensor_id" value="{{$maintenanceGps->equipment_sensor_id}}"></i></div>
</td>
<td>
    <select class="select equipment_gsm-{{$maintenanceGps->id}}" id="equipment_gsm" name="equipment_gsm">
        ...
        <option value="{{ $item->id }}" {{ old('equipment_gsm') == $item->id  ? 'selected':'' }}>{{$item->gsm_number}}</option>
        @endforeach
    </select>
</td>
<td>
    <select class="select task-{{$maintenanceGps->id}}" id="task" name="task-{{$maintenanceGps->id}}">
        <option selected value="{{ $maintenanceGps->task}}">{{ $maintenanceGps->taskRequest->task }}</option>

        @foreach ($task as $item)
        <option value="{{ $item->id }}">{{ $item->task }}</option>
        @endforeach
    </select>
</td>
<td>
    <select class="select ketersediaan_kendaraan-{{$maintenanceGps->id}}" id="ketersediaan_kendaraan" name="ketersediaan_kendaraan" aria-label=".form-select-lg example">
...
<td>
    <div class="input-div"><input type="text" class="input keterangan-{{$maintenanceGps->id}}" id="keterangan" value="{{$maintenanceGps->keterangan}}"></div>
</td>
<td>
    <div class="input-div"><input type="text" class="input hasil-{{$maintenanceGps->id}}" id="hasil" value="" required></div>
</td>
<td>
    <div class="input-div"><input type="number" class="input biaya_transportasi-{{$maintenanceGps->id}}" id="biaya_transportasi" value="" required></i></div>
</td>
<td>
...
<td>
    <select class="select req_by-{{$maintenanceGps->id}}" id="req_by" aria-label=".form-select-lg example">
        <option selected value="{{  $maintenanceGps->req_by == 'Customer' ? 'Customer' : 'CS'}}">{{  $maintenanceGps->req_by == 'Customer' ? 'Customer' : 'CS'}}</option>
        <option value="{{  $maintenanceGps->req_by == 'Customer' ? 'CS' : 'Customer'}}">{{  $maintenanceGps->req_by == 'Customer' ? 'CS' : 'Customer'}}</option>
    </select>
</td>
<td>
    <div class="input-div"><input type="text" class="input note_maintenance-{{$maintenanceGps->id}}" id="note_maintenance" value="{{$maintenanceGps->note_maintenance}}"></i></div>
</td>
<td>
    <select class="select status-{{$maintenanceGps->id}}" id="status" name="status" aria-label=".form-select-lg example" required>
