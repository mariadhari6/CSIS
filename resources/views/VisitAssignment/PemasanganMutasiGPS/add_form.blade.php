<tr id="add_form">
    ...
    <td><select class="form-control" id="tanggal" name="tanggal">
       @foreach ($request_complain as $request_complains)
    ...
    <td><select class="form-control" id="kendaraan_awal" name="kendaraan_awal">
       @foreach ($request_complain as $request_complains)
    ...
    <td><select class="form-control" id="imei" name="imei">
    ...
    <td><select class="form-control" id="kendaraan_pasang" name="kendaraan_pasang">
        @foreach ($request_complain as $request_complains)
     ...
     <td><select class="form-control" id="jenis_pekerjaan" name="jenis_pekerjaan">
       @foreach ($request_complain as $request_complains)
     ...
     <td><select class="form-control" id="equipment_terpakai_gps" name="equipment_terpakai_gps">
    ...
    <td><select class="form-control" id="equipment_terpakai_sensor" name="equipment_terpakai_sensor">
    ...
    <td><select class="form-control" id="teknisi" name="teknisi" aria-label=".form-select-lg example">
