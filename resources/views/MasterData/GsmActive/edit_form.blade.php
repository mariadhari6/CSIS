    ...
    <td></td>
    <td>
        <select class="form-control status_gsm-{{$GsmActive->id}}" id="status_gsm" name="status_gsm">
    ...
    <td>
        <div class="input-div"><input type="text" class="input gsm_number-{{$GsmActive->id}}" id="gsm_number" placeholder="Gsm Number" value="{{ $GsmActive->gsm_number}}"></div>
    </td>
    <td>
    ...
    <td>
        <div class="input-div"><input type="date" class="input request_date-{{$GsmActive->id}}" id="request_date" placeholder="Request Date" value="{{ $GsmActive->expired_date}}"></div>
    </td>
    <td>
        <div class="input-div"><input type="date" class="input active_date-{{$GsmActive->id}}" id="active_date" placeholder="Active Date" value="{{ $GsmActive->active_date}}"></div>
    </td>
    <td>
