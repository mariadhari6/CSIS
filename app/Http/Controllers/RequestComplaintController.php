...
class RequestComplaintController extends Controller
{
    ...
    public function add_form()
    {
        ...
        return view('RequestComplaint.data_request_complaint.add_form')->with([
            'pic'              => $pic,
            'company'          => $company,
    ...
    public function item_data()
    {
        ...
        // RequestComplaint::whereDate($day);
        // $year = RequestComplaint::whereMonth($month);
        // RequestComplaint::whereYear($year);
        // $year = RequestComplaint::whereYear('waktu_info', '2021')->first();
    ...
    public function edit_form($id)
    {
        ...
        return view('RequestComplaint.data_request_complaint.edit_form')->with([
