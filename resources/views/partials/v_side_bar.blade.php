<nav class="sidebar-new">
    ...
    <ul>
        ...
        <li class="nav-item
            ...
            <div class="collapse @yield('master')" id="masterData" aria-expanded="true">
                <ul class="drop">
...
{{-- <script>
   $('.sidebar-new').mouseover(function () {
    $('.logo-sidebar').empty();
        $('.logo-sidebar').append(
            `<li class="mt-2">
            <img src="{{ asset('images/odm_full.png') }}" width="120px" height="35px">
            </li>`
    );
}).mouseout(function () {
