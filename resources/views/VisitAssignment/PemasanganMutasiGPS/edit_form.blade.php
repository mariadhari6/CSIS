...
<td>
    <select class="select company_id-{{$pemasangan_mutasi_GPS->id}}" id="company_id" name="company_id">
      ...
      {{$request_complains->company->company_name}}
      </option>
      @endforeach
   </select>
</td>
<td>
   <select class="select tanggal-{{$pemasangan_mutasi_GPS->id}}" id="tanggal" name="tanggal">
...
<td>
   <select class="select kendaraan_awal-{{$pemasangan_mutasi_GPS->id}}" id="kendaraan_awal" name="kendaraan_awal">
...
<td>
   <select class="select gsm_pemasangan-{{$pemasangan_mutasi_GPS->id}}" id="gsm_pemasangan" name="gsm_pemasangan">
...
<td>
   <select class="select jenis_pekerjaan-{{$pemasangan_mutasi_GPS->id}}" id="jenis_pekerjaan" name="jenis_pekerjaan">
...
<td>
   <select class="select type_visit-{{$pemasangan_mutasi_GPS->id}}" id="type_visit" name="type_visit" aria-label=".form-select-lg example">
