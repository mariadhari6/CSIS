...
<td>
    <div class="input-div vehicle-{{$request_complaint->id}}"><input type="text" class="input vehicle-{{$request_complaint->id}}" id="vehicle" placeholder="vehicle" value="{{ $request_complaint->vehicle}}">
</div>
</td>
<td>
    <div class="input-div waktu_info-{{$request_complaint->id}}"><input type="datetime-local" class="input waktu_info-{{$request_complaint->id}}" id="waktu_info" placeholder="waktu_info" value="{{ $request_complaint->waktu_info}}">
</div>
</td>
    <td>
...
<td>
    <div class="input-div detail_task-{{ $request_complaint->id }}"><input type="text" class="input detail_task-{{$request_complaint->id}}" id="detail_task" placeholder="detail_task" value="{{ $request_complaint->detail_task}}"></i></div>
</td>
    <td>
...
<td>
    <div class="input-div waktu_respond-{{ $request_complaint->id }}"><input type="datetime-local" class="input waktu_respond-{{$request_complaint->id}}" id="waktu_respond" placeholder="waktu_respond" value="{{ $request_complaint->waktu_respond}}"></i></div>
</td>
    <td>
...
<td>
    <div class="input-div waktu_kesepakatan-{{ $request_complaint->id }}"><input type="datetime-local" class="input waktu_kesepakatan-{{$request_complaint->id}}" id="waktu_kesepakatan" placeholder="waktu_kesepakatan" value="{{ $request_complaint->waktu_kesepakatan}}"></i></div>
</td>
<td>
    <div class="input-div waktu_solve-{{ $request_complaint->id }}"><input type="datetime-local" class="input waktu_solve-{{$request_complaint->id}}" id="waktu_solve" placeholder="waktu_solve" value="{{ $request_complaint->waktu_solve}}"></i></div>
</td>
    <td>
...
<td>
    <div class="input-div status_akhir-{{ $request_complaint->id }}"><input type="text" class="input status_akhir-{{$request_complaint->id}}" id="status_akhir" placeholder="status_akhir" value="{{ $request_complaint->status_akhir}}"></i></div>
</td>