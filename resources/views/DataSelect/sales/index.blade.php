...
@section('title','CSIS | Sales')
@section('title-table', 'Sales')
@section('master','show')
...
<form onsubmit="return false">
    ...
    <div class="card">
        <div class="card-body">
          ...
          <table class="table table-responsive data" class="table_select" id="table_select" >
            <thead>
              <tr>
                <th scope="col" class="list-sellerName" style="text-align: center">Sales Name*</th>
  ...
  <script>
    ...
    function read(){
      $.get("{{ url('item_data_sales') }}", {}, function(data, status) {
     ...
     // ------ Tambah Form Input ------
     $('.add').click(function() {
        $.get("{{ url('add_form_sales') }}", {}, function(data, status) {
    ...
    function edit(id){
        ...
        $.get("{{ url('edit_form_sales') }}/" + id, {}, function(data, status) {
