    ...
    <td>
     ...
     <td>
        <select class="select gsm_pre_active_id-{{$GsmActive->id}}" id="gsm_pre_active_id" name="gsm_pre_active_id">
    ...
    <td>
        <select class="select status_active-{{$GsmActive->id}}" id="status_active" aria-label=".form-select-lg example">
    ...
    <td>
        <select class="select company_id-{{$GsmActive->id}}" id="company_id" name="company_id">
