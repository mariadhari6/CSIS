        ...
        foreach ($dataRequest as $key => $value) {
            ...
            if ($checkGsm === null && $checkSerial === null) {
                $data[$key] = array(
                    ...
                    'expired_date'      =>  $value->expired_date == null ? null :  $value->expired_date,
                    'active_date'       =>  $value->active_date == null ? null :  $value->active_date,
                    'terminate_date'    =>  $value->terminate_date == null ? null :  $value->terminate_date,
                    'note'              =>  $value->note,
